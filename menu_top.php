...
*/
?>
<a href="index.php">&nbsp;<?php echo $OWM_home ?></a> | <a href="index.php?main=repo_kontak"><?php echo $OWM_contact ?></a> | <a href="index.php?main=repo_help"><?php echo $OWM_help ?></a> | <a href="index.php?main=repo_feedback"><?php echo $OWM_feed ?></a>
