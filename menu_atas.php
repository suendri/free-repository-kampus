...
*/
?>
<span class="style1"> <span class="style2">Repository</span> | <span class="style3"><?php echo $row_recstatus['status_nama']; ?></span></span><br>
<br>
&nbsp;<em><?php echo $row_recstatus['status_moto']; ?></em>
