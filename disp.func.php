...
*/
$fmt_warning_ok = "<table width='650' height='50'><tr><td class='owm_feed'>&nbsp;<img src='template/image/ops.png'>&nbsp;=TITLE=</td></tr></table>";
$fmt_warning_fail = "<table width='650' height='50'><tr><td class='owm_feed'>&nbsp;<img src='template/image/oww.png'>&nbsp;=TITLE=</td></tr></table>";
$fmt_add_ok = "<table width='650' height='50'><tr><td class='owm_feed'>&nbsp;<img src='../template/image/oke.png'>&nbsp;=TITLE=</td></tr></table>";
$fmt_add_fail = "<table width='650' height='50'><tr><td class='owm_feed'>&nbsp;<img src='../template/image/remove.png'>&nbsp;=TITLE=</td></tr></table>";
