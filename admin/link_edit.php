...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE tautan SET tautan_link=%s, NotActive=%s WHERE tautan_title=%s",
...
if (isset($_GET['tautan_title'])) {
  $colname_Recordset1 = (get_magic_quotes_gpc()) ? $_GET['tautan_title'] : addslashes($_GET['tautan_title']);
}
mysql_select_db($database_koneksi, $koneksi);
$query_Recordset1 = sprintf("SELECT * FROM tautan WHERE tautan_title = '%s'", $colname_Recordset1);
...
<form name="form1" method="POST" action="<?php echo $editFormAction; ?>">
  <table cellpadding="1" cellspacing="2">
    <tr>
      ...
      <td class="ttl"><input name="textfield" type="text" value="<?php echo $row_Recordset1['tautan_title']; ?>"></td>
    </tr>
    <tr>
      <td class="ttl">Alamat</td>
      <td class="ttl"><input name="textfield2" type="text" value="<?php echo $row_Recordset1['tautan_link']; ?>" size="50"></td>
    </tr>
    <tr>
    ...
    <tr>
      <td class="ttl">&nbsp;</td>
      <td class="ttl"><input type="submit" name="Submit" value="Submit">
