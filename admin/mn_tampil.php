...
<p><i>Master Menu Utama</i></p>
<a href="index.php?main=mn_add">Tambah Menu</a><table cellpadding="2" cellspacing="2">
  <tr>
    <td class="lst">Nama Menu </td>
  ...
  <?php do { ?>
  <tr>
    <td class="ttl"><?php echo $row_Recordset1['utama_title']; ?></td>
    <td class="ttl"><?php echo $row_Recordset1['utama_link']; ?></td>
    <td class="ttl"><?php echo $row_Recordset1['NotActive']; ?></td>
    <td class="ttl"><a href="index.php?main=mn_edit&utama_title=&utama_title=<?php echo $row_Recordset1['utama_title']; ?>">Edit</a></td>
  </tr>
